...
export const blogPosts: BlogPost[] = [
    {
        title: "Introducing Reliable: semantic search for procurement law",
        excerpt: "Reliable is our semantic search tool for public procurement law. It retrieves the decisions most relevant to your question, at paragraph level, across complaint-board practice, statutes and EU law, with every result linked to its authoritative source.",
        date: "5 June 2026",
        ...
        content: `
            ...
            <p>National court practice is being added next. If you work with public procurement and want to see how Reliable handles a question from your own practice, we would be glad to show you. Bring a real question. We will run it live, and you can judge the results yourself.</p>
        `
    },
    {
    ...
    },
    {
        ...
        excerpt: "We're grateful to have been featured in Universitas, Norway's largest student newspaper, and Digital Norway, covering our journey from university research to award-winning AI technology.",
        date: "26 March 2026",
        category: "Press",
