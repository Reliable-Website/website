...
export const blogPostsNo: BlogPost[] = [
    {
        title: "Vi lanserer Reliable: semantisk søk i anskaffelsesretten",
        excerpt: "Reliable er vårt verktøy for semantisk søk i anskaffelsesretten. Det henter frem de mest relevante avgjørelsene for spørsmålet ditt, på avsnittsnivå, på tvers av nemndspraksis, lov og forskrift og EU-rett, og hvert treff er lenket til den autoritative kilden.",
        date: "5. juni 2026",
        ...
        content: `
            ...
            <p>Nasjonal domstolspraksis legges til som det neste. Arbeider du med offentlige anskaffelser og vil se hvordan Reliable håndterer en problemstilling fra egen praksis, viser vi deg gjerne. Ta med et reelt spørsmål. Vi kjører det live, og du vurderer resultatene selv.</p>
        `
    },
    {
