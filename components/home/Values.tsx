            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 lg:gap-12">
                    {values.map((item, index) => (
                        <div
                            key={item.key}
                            className="group relative p-4 md:p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-primary/20 hover:bg-white/10 transition-all duration-500 backdrop-blur-sm"
                        >
